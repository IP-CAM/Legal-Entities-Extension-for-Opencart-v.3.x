...
class ControllerSaleOrder extends Controller {
	...
	public function index() {
		...
		$this->load->model('sale/legal_entities_nik');

		$this->model_sale_legal_entities_nik->install();
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $data['legal_entities_info'] = $this->model_sale_legal_entities_nik->getLegalEntitiesInfo($this->request->get['order_id']);

//            var_dump($data['legal_entities_info']);
